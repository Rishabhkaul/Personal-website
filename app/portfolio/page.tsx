export default function PortfolioPage() {
  ...
  <li>
    <a href="https://pavoai.com/" target="_blank" rel="noopener noreferrer">
      Pavo
    </a>
  </li>
  <li>
    <a href="https://akashx.ai" target="_blank" rel="noopener noreferrer">
      AkashX
    </a>
  </li>
  <li>
    <a href="https://collekt.ai" target="_blank" rel="noopener noreferrer">
      Collekt
    </a>
  </li>
  <li>
    <a href="https://detail.dev" target="_blank" rel="noopener noreferrer">
      Detail
    </a>
  </li>
  <li>
    <a href="https://budy.bot" target="_blank" rel="noopener noreferrer">
      Budy
    </a>
  </li>
  <li>
    <a href="https://segwise.ai" target="_blank" rel="noopener noreferrer">
      Segwise
    </a>
  </li>
  <li>
